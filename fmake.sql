...
--
-- Host: localhost
-- Generation Time: Nov 07, 2011 at 06:56 PM
...
INSERT INTO `projects_seo` (`id_project`, `id_sape`, `id_webmaster`, `date_create`, `date_payment`, `abonement`, `consecutive_calculation`, `liveinternet_password`, `metrika`, `sape_money`, `active`) VALUES
(2, 333232, 123123, 0, 1323374400, 2000, '0', '12342', '12312', 3000, '1');

-- --------------------------------------------------------

--
-- Table structure for table `projects_seo_access_role`
--

CREATE TABLE IF NOT EXISTS `projects_seo_access_role` (
  `id_project` int(11) NOT NULL DEFAULT '0',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='seo запросы' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `projects_seo_search_system_exs` (
  ...
  `to` int(11) NOT NULL,
  PRIMARY KEY (`id_exs`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='правила расчёта для проектов' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Модуль и доступ роли' AUTO_INCREMENT=84 ;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  PRIMARY KEY (`id_user`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Пользователи сайта' AUTO_INCREMENT=15 ;
